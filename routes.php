...
$controllers = array('pages'=>['home','error'],
                    'quotation'=>['index','newQuotation'],
                    'quotationDetail'=>['index','newQuotationDetail','addQuotationDetail'],
                    'productRate'=>['index', 'newProductRate', 'addProductRate', 'search', 'updateForm']);
